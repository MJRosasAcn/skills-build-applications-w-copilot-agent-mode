...
function App() {
  return (
    <Router>
      <nav className="navbar navbar-expand-lg navbar-dark bg-octofit shadow">
        <div className="container-fluid">
          <Link className="navbar-brand d-flex align-items-center" to="/">
            <img src={octofitLogo} alt="Octofit Logo" className="me-2" style={{height: '36px', width: '36px'}} />
          ...
          <Route path="/" element={
            <div className="card text-center">
              <div className="card-body">
                ...
                <p className="card-text lead">Track your fitness, activities, teams, and more with a beautiful modern UI.</p>
